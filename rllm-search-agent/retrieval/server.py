...
class LocalRetriever:
    ...
    def __init__(self, data_dir: str):
        ...
        self.encoder = SentenceTransformer("/mnt/public/sunjinfeng/base_llms/hub/AI-ModelScope/e5-base-v2")
...
class RetrievalRequest(BaseModel):
    ...
    k: int | None = Field(None, description="Alternative parameter for number of results")
...
class RetrievalResponse(BaseModel):
    ...
    results: list[RetrievalResultItem] = Field(..., description="List of retrieved documents")
...
@app.post("/retrieve", response_model=RetrievalResponse, summary="Retrieve relevant documents")
...
def main():
    ...
    parser.add_argument("--data_dir", default="mnt/public/sunjinfeng/data/search_data/prebuilt_indices", help="Directory containing corpus and dense index")
